...
namespace nmpc_control_nodelet
{
    ...
    static constexpr int kSamples = MPC_N;
    static constexpr int yRefSize = PAYLOAD_MODEL_NX -1 + PAYLOAD_MODEL_NU;
    ...
    bool prepare(const Eigen::Ref<const Eigen::Matrix<double, kStateSize, kSamples>> states)
    bool update(const Eigen::Ref<const Eigen::Matrix<double, kInputSize, kSamples>> states)
    void getStatus(Eigen::Matrix<double, kStateSize, kSamples> &return_state);
    void getInputs(Eigen::Matrix<double, kStateSize, kSamples> &return_input);
    ...
    Eigen::Matrix<real_t, kInputSize, 1> kHoverInput_ = (Eigen::Matrix<real_t, kInputSize, 1>() << 0.0, 0.0, 0.0, 0.0).finished();
    };
