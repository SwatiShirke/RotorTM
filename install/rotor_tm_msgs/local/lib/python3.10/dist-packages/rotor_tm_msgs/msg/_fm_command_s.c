...
bool rotor_tm_msgs__msg__fm_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rotor_tm_msgs.msg._fm_command.FMCommand", full_classname_dest, 39) == 0);
  }
  rotor_tm_msgs__msg__FMCommand * ros_message = _ros_message;
  {  // header
...
PyObject * rotor_tm_msgs__msg__fm_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rotor_tm_msgs.msg._fm_command");
