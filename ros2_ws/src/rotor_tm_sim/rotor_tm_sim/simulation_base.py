...
class simulation_base(Node):
    ...
    def __init__(self,pl_params,uav_params):
        ...
        self.payload_odom_ground_truth_publisher = self.create_publisher(Odometry, 'payload/odom_ground_truth', qos_profile)
        self.payload_path_publisher = self.create_publisher(Path, 'payload/path', qos_profile )
