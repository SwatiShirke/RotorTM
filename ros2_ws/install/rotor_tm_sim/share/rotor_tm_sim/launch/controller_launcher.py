...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('index', default_value = PythonExpression([ LaunchConfiguration('number_of_robots'),  '-1*',  LaunchConfiguration('nr')  ])),
        ...
        Node(
            ...
            name=PythonExpression(["'s' + str(", LaunchConfiguration('nr'), ")"]),
            output='screen',
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'nr': PythonExpression([LaunchConfiguration('nr')])
            }.items()
        ),
    ])
