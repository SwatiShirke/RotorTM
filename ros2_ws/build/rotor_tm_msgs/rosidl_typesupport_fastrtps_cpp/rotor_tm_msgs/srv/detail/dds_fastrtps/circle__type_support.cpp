...
#include "rotor_tm_msgs/srv/detail/circle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rotor_tm_msgs::srv::Circle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rotor_tm_msgs::srv::Circle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rotor_tm_msgs::srv::Circle_Request *>(
    untyped_ros_message);
...
{
  return &rotor_tm_msgs::srv::typesupport_fastrtps_cpp::_Circle_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rotor_tm_msgs::srv::Circle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rotor_tm_msgs::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rotor_tm_msgs::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rotor_tm_msgs::srv::typesupport_fastrtps_cpp::_Circle_Response__handle;
}
...
{
  return &rotor_tm_msgs::srv::typesupport_fastrtps_cpp::_Circle__handle;
}
