...
static const _SO3Command_type_support_symbol_names_t _SO3Command_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rotor_tm_msgs, msg, SO3Command)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rotor_tm_msgs, msg, SO3Command)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rotor_tm_msgs, msg, SO3Command)() {
  return &::rotor_tm_msgs::msg::rosidl_typesupport_c::SO3Command_message_type_support_handle;
}
