...
{
  new (message_memory) rotor_tm_msgs::msg::SO3Command(_init);
}

void SO3Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rotor_tm_msgs::msg::SO3Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SO3Command_message_member_array[6] = {
  {
    ...
    offsetof(rotor_tm_msgs::msg::SO3Command, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rotor_tm_msgs::msg::SO3Command, force),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rotor_tm_msgs::msg::SO3Command, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rotor_tm_msgs::msg::SO3Command, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(rotor_tm_msgs::msg::SO3Command, k_r),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(rotor_tm_msgs::msg::SO3Command, k_om),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SO3Command_message_members = {
  ...
  6,  // number of fields
  sizeof(rotor_tm_msgs::msg::SO3Command),
...
{
  return &::rotor_tm_msgs::msg::rosidl_typesupport_introspection_cpp::SO3Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rotor_tm_msgs, msg, SO3Command)() {
  return &::rotor_tm_msgs::msg::rosidl_typesupport_introspection_cpp::SO3Command_message_type_support_handle;
}
