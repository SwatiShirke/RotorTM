...
class Metaclass_TrajCommand(type):
    """Metaclass of message 'TrajCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rotor_tm_msgs.msg.TrajCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traj_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traj_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traj_command
...
class TrajCommand(metaclass=Metaclass_TrajCommand):
    """Message class 'TrajCommand'."""
