...
static const _TrajCommand_type_support_symbol_names_t _TrajCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rotor_tm_msgs, msg, TrajCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rotor_tm_msgs, msg, TrajCommand)),
  }
};
...
{
  return &::rotor_tm_msgs::msg::rosidl_typesupport_cpp::TrajCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rotor_tm_msgs, msg, TrajCommand)() {
  return get_message_type_support_handle<rotor_tm_msgs::msg::TrajCommand>();
}
