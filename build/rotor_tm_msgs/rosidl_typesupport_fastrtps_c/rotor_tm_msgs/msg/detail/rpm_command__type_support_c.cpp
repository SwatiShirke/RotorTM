...
#include "rotor_tm_msgs/msg/detail/rpm_command__rosidl_typesupport_fastrtps_c.h"
...
using _RPMCommand__ros_msg_type = rotor_tm_msgs__msg__RPMCommand;
...
size_t get_serialized_size_rotor_tm_msgs__msg__RPMCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RPMCommand__ros_msg_type * ros_message = static_cast<const _RPMCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RPMCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rotor_tm_msgs__msg__RPMCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rotor_tm_msgs
size_t max_serialized_size_rotor_tm_msgs__msg__RPMCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rotor_tm_msgs__msg__RPMCommand;
    is_plain =
      (
      offsetof(DataType, rpms) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _RPMCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rotor_tm_msgs__msg__RPMCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rotor_tm_msgs, msg, RPMCommand)() {
