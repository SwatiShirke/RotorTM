...
#include "rotor_tm_msgs/msg/detail/position_command__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, angular_velocity, jerk, velocity
...
using _PositionCommand__ros_msg_type = rotor_tm_msgs__msg__PositionCommand;
...
static uint32_t _PositionCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rotor_tm_msgs__msg__PositionCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rotor_tm_msgs__msg__PositionCommand;
    is_plain =
      (
...
static size_t _PositionCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rotor_tm_msgs__msg__PositionCommand(
