...
#include "rotor_tm_msgs/msg/detail/so3_command__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_velocity, force
...
using _SO3Command__ros_msg_type = rotor_tm_msgs__msg__SO3Command;
...
size_t get_serialized_size_rotor_tm_msgs__msg__SO3Command(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SO3Command__ros_msg_type * ros_message = static_cast<const _SO3Command__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SO3Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rotor_tm_msgs__msg__SO3Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rotor_tm_msgs
size_t max_serialized_size_rotor_tm_msgs__msg__SO3Command(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rotor_tm_msgs__msg__SO3Command;
    is_plain =
      (
...
static size_t _SO3Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rotor_tm_msgs__msg__SO3Command(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rotor_tm_msgs, msg, SO3Command)() {
