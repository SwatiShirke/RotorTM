...
#include "rotor_tm_msgs/msg/detail/rpm_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rotor_tm_msgs::msg::RPMCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rotor_tm_msgs::msg::RPMCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rotor_tm_msgs::msg::RPMCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rotor_tm_msgs::msg::RPMCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rotor_tm_msgs::msg::RPMCommand *>(
    untyped_ros_message);
...
{
  return &rotor_tm_msgs::msg::typesupport_fastrtps_cpp::_RPMCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rotor_tm_msgs, msg, RPMCommand)() {
  return &rotor_tm_msgs::msg::typesupport_fastrtps_cpp::_RPMCommand__handle;
}
